...
<ul class="showcase__list d-flex justify-content-between">
          <li class="showcase__item none_first-item">
            <img
              class="showcase__image"
              src="img/features-4.png"
              alt="showcase-1"
            />
            <p class="showcase__item-title">ELLERY X M'O CAPSULE</p>
            <p class="showcase__item-desc">
              Known for her sculptural takes on traditional tailoring,
              Australian arbiter of cool Kym Ellery teams up with Moda Operandi.
            </p>
            <p class="showcase__item-price">$52.00</p>
          </li>
          ...
          <li class="showcase__item none_third-item">
            <img
              class="showcase__image"
