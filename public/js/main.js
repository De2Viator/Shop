import './UI/FooterComponent';
import './UI/SubscriptionComponent';
import './UI/HeaderComponent';
Vue.component("product", {
    ...
    template: `
        ...
        />
        <div class="overlay">
          <button class="buy-button" @click="$emit('add-product', product)">
          <svg class="buy-button-image" width="33" height="29" viewBox="0 0 33 29" fill="none" xmlns="http://www.w3.org/2000/svg">
